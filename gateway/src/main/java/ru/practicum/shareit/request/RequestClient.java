...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(CreateItemRequestDto itemRequest, Long userId) {
        return post("", userId, itemRequest);
    }

    public ResponseEntity<Object> findAllMyRequests(Long userId, Integer from, Integer size) {
